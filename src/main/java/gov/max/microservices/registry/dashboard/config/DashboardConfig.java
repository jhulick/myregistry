package gov.max.microservices.registry.dashboard.config;

import com.netflix.discovery.EurekaClient;

import com.netflix.eureka.registry.PeerAwareInstanceRegistry;

import gov.max.microservices.registry.dashboard.repository.ApplicationRepository;
import gov.max.microservices.registry.dashboard.repository.eureka.LocaleEurekaRepository;
import gov.max.microservices.registry.dashboard.repository.eureka.RemoteEurekaRepository;
import gov.max.microservices.registry.dashboard.stream.CircuitBreakerStreamServlet;
